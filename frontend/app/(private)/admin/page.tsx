    ...
    <div className="min-h-screen" style={{ backgroundColor: '#101828'}}>
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Link href="/admin/proyectos" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow" style={{ backgroundColor: '#1e2939'}}>
            <h2 className="text-xl font-bold text-blue-300 mb-2">Proyectos Destacados</h2>
            <p className="text-gray-300">Crear, editar y publicar proyectos en la landing</p>
          </Link>
        </div>
      </div>
    </div>
